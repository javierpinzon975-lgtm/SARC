...
export default function AuthSection() {
    ...
    function handleRegister(e) {
        ...
        if (role === 'paciente') {
            ...
            if (ok) {
                setRegData({ role: 'paciente', nombre: '', id: '', fechaNacimiento: '', regimen: '', celular: '', correo: '' });
                setTab('login');
            }
            return;
        }
    ...
    return (
        <section id="auth-section" className="glass-card">
            ...
            <form className={`auth-form${tab === 'register' ? ' active' : ''}`} onSubmit={handleRegister}>
                ...
                <div className="form-group">
                    <label htmlFor="reg-role">Tipo de Rol</label>
                    <select
                        id="reg-role" required
                        value={regData.role}
